...
const dummyQuestions = [
    {
        id: 1,
        question: "Which of the following best describes your learning preferences?",
        options: [
          { id: 1, text: "Visual Learning (e.g., videos, images)", type: "radio" },
          { id: 2, text: "Auditory Learning (e.g., lectures, discussions)", type: "radio" },
          { id: 3, text: "Kinesthetic Learning (e.g., hands-on activities)", type: "radio" },
          { id: 4, text: "Reading/Writing (e.g., text-based materials)", type: "radio" },
        ],
      },
    {
      id: 2,
...
const Questions = () => {
  return (
    <>
      <p className="text-lg text-gray-600 mb-8">Modules / Questions</p>
