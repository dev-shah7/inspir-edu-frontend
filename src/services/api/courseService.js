...
export const courseService = {
  ...
  guestGetCourseByToken: async (token) => {
    try {
      const response = await api.get(`/api/GuestCourse/get-by-token/${token}`);
      return response.data;
    } catch (error) {
  ...
  guestSaveCourse: async (courseData) => {
    try {
      const response = await api.post("/api/GuestCourse/save", courseData);
      return response.data;
    } catch (error) {
  ...
  guestGetGradingInstructions: async (courseId) => {
    try {
      const response = await api.get(`/api/GuestCourse/get-grading-instructions/${courseId}`);
      return response.data;
    } catch (error) {
  ...
  guestSaveGradingInstructions: async (instructionsData) => {
    try {
      const response = await api.post("/api/GuestCourse/save-grading-instructions", instructionsData);
      return response.data;
    } catch (error) {
  ...
  guestDeleteCourse: async (id) => {
    try {
      const response = await api.delete(`/api/GuestCourse/delete/${id}`);
      return response.data;
    } catch (error) {
